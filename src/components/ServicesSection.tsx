...
const ServicesSection = () => (
  <section id="services" className="py-16 sm:py-24 px-4 max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
      {services.map((s) => (
        <div
          key={s.title}
          className="reveal bg-card border-2 sm:border-4 border-foreground p-6 sm:p-8 shadow-hard hover:shadow-hard-xl transition-all group"
        >
