      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="reveal flex flex-col h-full">
          ...
          <div className="border-4 border-background/20 p-6 bg-foreground flex-1 flex flex-col shadow-hard-lg relative">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8 uppercase">
              <div className="border-2 border-neo-green/30 bg-foreground p-4 hover:border-neo-green transition-colors">
                <div className="text-[9px] font-mono text-neo-green mb-1 uppercase tracking-widest opacity-70">Repositories</div>
                <div className="font-black text-3xl tracking-tighter">10+</div>
              </div>
              <div className="border-2 border-neo-green/30 bg-foreground p-4 hover:border-neo-green transition-colors">
                <div className="text-[9px] font-mono text-neo-green mb-1 uppercase tracking-widest opacity-70">Followers</div>
                <div className="font-black text-3xl tracking-tighter">--</div>
              </div>
              <div className="border-2 border-neo-green/30 bg-foreground p-4 hover:border-neo-green transition-colors">
              ...
              <div className="border-2 border-neo-green/30 bg-foreground p-4 hover:border-neo-green transition-colors">
                ...
                <div className="font-black text-xl tracking-tighter mt-1 leading-none">2024</div>
              </div>
            </div>
            ...
            {/* Command Footer */}
            <div className="mt-auto flex items-center justify-between text-neo-green p-3 border-2 border-background/10 font-mono text-[11px]">
              <div className="flex items-center gap-2">
        ...
        <div className="reveal flex flex-col h-full">
          ...
          <div className="border-4 border-background/20 p-6 bg-foreground flex-1 flex flex-col shadow-hard-lg relative">
            ...
            {/* Stats Grid */}
            <div className="grid grid-cols-2 gap-4 mb-8 uppercase">
              <div className="border-2 border-neo-red/30 bg-foreground p-4 hover:border-neo-red transition-colors">
                <div className="text-[9px] font-mono text-neo-red mb-1 uppercase tracking-widest opacity-70">Rooms Completed</div>
                <div className="font-black text-3xl tracking-tighter">--</div>
              </div>
              <div className="border-2 border-neo-red/30 bg-foreground p-4 hover:border-neo-red transition-colors">
                <div className="text-[9px] font-mono text-neo-red mb-1 uppercase tracking-widest opacity-70">Badges</div>
                <div className="font-black text-3xl tracking-tighter">--</div>
              </div>
              <div className="border-2 border-neo-red/30 bg-foreground p-4 hover:border-neo-red transition-colors">
                <div className="text-[9px] font-mono text-neo-red mb-1 uppercase tracking-widest opacity-70">Rank</div>
                <div className="font-black text-3xl tracking-tighter">--</div>
              </div>
              <div className="border-2 border-neo-red/30 bg-foreground p-4 hover:border-neo-red transition-colors">
                <div className="text-[9px] font-mono text-neo-red mb-1 uppercase tracking-widest opacity-70">Streak</div>
                <div className="font-black text-xl tracking-tighter mt-1 leading-none">--</div>
              </div>
            </div>

            {/* TryHackMe Badge */}
            <div className="flex-1 flex flex-col justify-center mb-8">
              <div className="border-2 border-neo-red/30 p-4 overflow-hidden hover:border-neo-red transition-colors relative">
                ...
                <div className="text-center py-8 font-mono text-muted-foreground">
                  <Shield size={48} className="mx-auto mb-3 text-neo-red opacity-50" />
                  <p className="text-sm">TryHackMe profile badge will appear here</p>
                  <p className="text-xs mt-1 text-neo-red">Update with your TryHackMe username</p>
                </div>
              </div>
            </div>

            {/* Command Footer */}
            <div className="mt-auto flex items-center justify-between text-neo-red p-3 border-2 border-background/10 font-mono text-[11px]">
              <div className="flex items-center gap-2">
                <span className="text-background/30">$</span>
